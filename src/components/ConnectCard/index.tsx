    ...
    return (
        <div className={styles.card}>
            ...
            <p className={styles.card__desc}>
                Welcome to Bandit City, the digital realm where privacy isn&apos;t just an option,
                it&apos;s the foundation.{' '}
            </p>

            <Button onClick={onWalletConnect} width="100%">
                Connect with Zano Wallet
            </Button>

            <Link
                href="https://docs.zano.org/docs/use/companion/"
                target="_blank"
                className={styles.card__info}
            >
                <InfoIcon /> How to connect<span className="nofont">?</span>
            </Link>
        </div>
    );
};
