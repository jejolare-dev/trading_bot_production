        ...
        <aside className={styles.sidebar}>
            <div>
                ...
                <div className={classes(styles.sidebar__info, styles.sidebar__item)}>
                    <div className={styles.sidebar__info_avatar}>
                        {walletData?.alias.slice(0, 1)}
                    </div>
                    <div className={styles.sidebar__info_alias}>
                        ...
                        <div className={styles.address}>
                            ...
                            <InfoIcon
                                onClick={onCopy}
                                Icon={CopyIcon}
                                info={isCopied ? 'The address coppied' : 'Copy address'}
                                RightIcon={<CopyIcon className={styles.copyIcon} />}
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className={classes(styles.sidebar__balance, styles.sidebar__item)}>
                    ...
                    <p>
                        ...
                        <span className={styles.sidebar__balance_total}>
                            {totalZanoUsd?.toFixed(2).toLocaleString()}
                        </span>
                        <span
                            className={classes(
                                styles.sidebar__balance_status,
                                Number(zanoUsd24Change) < 0 &&
                                    styles.sidebar__balance_status_negative,
                            )}
                        >
                            {zanoUsd24Change?.toFixed(2)}%
                        </span>
                    </p>
                </div>
