...
export function Background() {
  return (
    <div className={styles.background}>
      ...
      <Roundel
        className={classes(
          styles.background__crumb1,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb2,
          styles.background__cosmo_object
        )}
      />
      <Star
        className={classes(
          styles.background__crumb3,
          styles.background__cosmo_object
        )}
      />
      <Star
        className={classes(
          styles.background__crumb4,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb5,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb6,
          styles.background__cosmo_object
        )}
      />
      <Star
        className={classes(
          styles.background__crumb7,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb8,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb9,
          styles.background__cosmo_object
        )}
      />
      <Star
        className={classes(
          styles.background__crumb10,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb11,
          styles.background__cosmo_object
        )}
      />
      <Star
        className={classes(
          styles.background__crumb12,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb13,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb14,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb15,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb16,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb17,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb18,
          styles.background__cosmo_object
        )}
      />
      <Roundel
        className={classes(
          styles.background__crumb19,
          styles.background__cosmo_object
        )}
      />
      <Star
        className={classes(
          styles.background__crumb20,
          styles.background__cosmo_object
        )}
      />
      <Star
        className={classes(
          styles.background__crumb21,
          styles.background__cosmo_object
        )}
      />
